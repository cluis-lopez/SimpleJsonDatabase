...
public class GroupDatabase extends SimpleJsonDatabase<Group>{
	 ...
	 * 
	 * @param s String containing Json object with "id" string key and "user" object representing the user to add in the list
	 * @return Returns a JsonObject with key "code" and the result of the operation
	 */
	 ...
	 * 
	 * @param s String containing Json object with "id" of the group and "User" object representing the user to be removed from the list
	 * @return Returns a JsonObject with key "code" and the result of the operation
	 */
	 ...
	 * @return Returns a JsonObject with key "code" and the result of the operation and a Json object representation of the Group
	 */
	 ...
	 * @param s String containing the name to look for
	 * @return Returns a JsonObject with key "code" and the result of the operation
	 *  and a Json array with the list of groups whose names math (contains) the wildchar
	 */
	 ...
	 * @return Returns a JsonObject with key "code" and the result of the operation
	 *  and a Json array with the list of groups owned by this user or empty if the user
	 *  does not own any group
	 */
	 ...
	 * @param s String containing the name of the owner
	 * @return Returns a JsonObject with key "code" and the result of the operation
	 *  and a Json array with the list of groups that this user belongs to or empty if the user
	 *  does not own any group
	 */
